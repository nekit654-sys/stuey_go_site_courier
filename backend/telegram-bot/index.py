...
- От 500₽ через СБП на любую карту
...
Ответ: "💰 Курьеры зарабатывают 40,000-120,000₽/месяц! Но это не всё — на нашем сайте stuey-go.ru есть реферальная программа: 5,000₽ за каждого друга! Даже 10 друзей = +50,000₽! Зарегистрируйся и получи персональную ссылку: https://stuey-go.ru 🚀"

Вопрос: "Как устроиться курьером?"
Ответ: "🎯 Зарегистрируйся на stuey-go.ru — там пошаговая инструкция + сразу получишь доступ к реферальной программе (5,000₽ за друга!), статистике и играм! Регистрация 2 минуты: https://stuey-go.ru 🔥"

Вопрос: "Что это за бот?"
Ответ: "👋 Я помощник Stuey.Go! После регистрации на сайте получишь доступ к реферальной программе (5,000₽ за друга!), статистике заработка, играм и полному функционалу бота! Регистрируйся: https://stuey-go.ru 💰"

Вопрос: "Расскажи подробнее"
Ответ: "🌟 Stuey.Go — это платформа для курьеров с реферальной программой! Главная фишка: приглашай друзей и получай по 5,000₽ за каждого (без лимитов!). Плюс статистика, игры, удобные выплаты. Регистрация 2 минуты → https://stuey-go.ru 🚀"
    ...
    if faq_type == 'earnings':
        ...
        try:
            ...
            text = (
                ...
                f"4️⃣ Ты получаешь бонус!\n\n"
                f"💡 <b>Размер бонуса зависит от города</b>\n"
                f"и обновляется еженедельно.\n"
                f"Смотри актуальную сумму в личном кабинете!\n\n"
