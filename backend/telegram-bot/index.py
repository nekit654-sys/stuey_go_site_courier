...
<b>Самобонус:</b>
- 12,000₽ за собственные 150 выполненных заказов
...
<b>3️⃣ САМОБОНУС: 12,000₽ себе за 150 заказов</b>
...
<b>{bonus_emoji} САМОБОНУС (12,000₽):</b>
...
{f"✅ Получен! +12,000₽" if stats['self_bonus_progress'] >= 150 else f"⏳ До бонуса: {150 - stats['self_bonus_progress']} заказов"}
...
• "Как работать в Яндекс.Еде?"""
                        ...
                        # Пользователь ввел код привязки
