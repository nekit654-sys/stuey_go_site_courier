...
**АРЕНДА ТРАНСПОРТА (велосипед, самокат):**

1️⃣ **Яндекс Про - ЛУЧШИЙ ВАРИАНТ!**
   - В приложении Яндекс Про есть аренда от 1₽/день
   - Как найти: Яндекс Про → Профиль → Аренда транспорта
   - Условия: специальные тарифы для курьеров
   - Города: Москва, СПб, крупные города РФ

2️⃣ **Альтернативы по городам:**
   - **Москва**: Whoosh (электросамокаты), Велобайк (велопрокат), Делимобиль (автомобили)
   - **Санкт-Петербург**: Whoosh, велопрокат Велогород
   - **Екатеринбург**: Urban Scooter, велопрокат
   - **Другие города**: местные сервисы проката
   
3️⃣ **Если спрашивают без города** → спроси: "В каком городе тебе нужна аренда?"
...
**ОФИСЫ И ТОЧКИ ЯНДЕКСА:**
- Москва: офис на ул. Льва Толстого, 16 (метро Парк Культуры)
- Санкт-Петербург: БЦ "Сенатор" (Невский пр.)
- Другие города: смотри в приложении Яндекс Про → Поддержка → Контакты
