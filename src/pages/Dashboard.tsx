...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      {/* Киберпанк фон с анимированными элементами */}
      <div className="fixed inset-0 -z-10">
        <div className="absolute inset-0 bg-gradient-to-br from-cyber-dark via-cyber-darker to-black" />
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-cyber-cyan/10 rounded-full blur-3xl animate-glow-float" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-cyber-pink/10 rounded-full blur-3xl animate-glow-float" style={{ animationDelay: '1.5s' }} />
        <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-cyber-purple/10 rounded-full blur-3xl animate-glow-float" style={{ animationDelay: '3s' }} />
        {/* Сетка */}
