...
const Hiring = () => {
  ...
  const requirements = [
    ...
    },
    {
      icon: "FileCheck",
      title: "Документы",
      description: "Паспорт РФ, ИНН, СНИЛС",
    },
    {
      icon: "Smartphone",
      title: "Смартфон",
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Нет, медицинская книжка не требуется. Достаточно паспорта РФ, ИНН и СНИЛС. Курьеры доставляют упакованную еду, поэтому санкнижка не нужна.",
    },
    {
