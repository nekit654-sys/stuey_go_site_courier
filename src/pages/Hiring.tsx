        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid gap-8 mb-16">
            {steps.map((step, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-8 shadow-xl border-l-8 border-yellow-400 hover:shadow-2xl transition-all duration-300"
              >
          ...
          <div className="bg-gradient-to-br from-yellow-400 to-orange-400 rounded-2xl p-8 text-center shadow-2xl">
            ...
            <Button
              onClick={handleStart}
              className="bg-gray-800 hover:bg-gray-900 text-white font-bold px-8 py-4 text-lg shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105"
            >
