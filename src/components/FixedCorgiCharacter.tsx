  ...
  return (
    <div className="fixed bottom-4 left-4 md:left-8 z-50">
      ...
      <button
        ...
        className="absolute -bottom-6 -left-6 w-8 h-8 opacity-30 hover:opacity-50 bg-red-500 rounded-full transition-opacity duration-200 flex items-center justify-center"
