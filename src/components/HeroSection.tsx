...
const HeroSection = () => {
  ...
  return (
    <section
      className="relative bg-cover bg-center bg-no-repeat text-white px-6 border-t-4 border-b-4 border-yellow-400 rounded-3xl mx-0 my-8 overflow-hidden shadow-2xl py-[49px]"
      style={{
        backgroundImage:
