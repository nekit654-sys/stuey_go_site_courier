    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        ...
        <div className="backdrop-blur-md bg-white/5 border border-yellow-400/30 rounded-2xl p-10 shadow-xl ring-1 ring-white/10">
          ...
          <p className="md:text-2xl max-w-3xl leading-relaxed font-medium px-0 mx-[87px] text-center my-[60px] text-3xl text-[#ffffff]">
            Станьте курьером! Мы предлагаем различные варианты доставки: пешие
            маршруты, доставка на велосипеде или самокате, а также доставка на
            автомобиле. Выберите тот формат, который ⬇️ подходит вам больше
            всего ⬇️
          </p>
