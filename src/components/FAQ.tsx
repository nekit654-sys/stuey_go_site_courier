...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Первая выплата приходит уже через неделю после начала работы. Далее выплаты происходят еженедельно каждый понедельник.",
      icon: "Wallet"
    },
    {
    ...
    <section className="py-20 px-4 bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4 font-rubik flex items-center justify-center gap-3">
            <Icon name="MessageCircleQuestion" size={40} className="text-yellow-500" />
            Частые вопросы
          </h2>
