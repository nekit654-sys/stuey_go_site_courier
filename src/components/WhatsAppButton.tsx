      ...
      {showBubble && (
        <div className="absolute -top-16 -left-32 animate-bounce">
          ...
          >
            ...
            <div className="absolute bottom-[-7px] right-4 w-0 h-0 border-l-8 border-l-transparent border-r-8 border-r-transparent border-t-8 border-t-gray-200"></div>
          </div>
        </div>
      )}
