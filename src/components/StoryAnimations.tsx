...
export default function StoryAnimations({ animationType, animationConfig }: StoryAnimationsProps) {
  ...
  if (animationType === 'jumping' && animationConfig?.jumpingImage) {
    ...
    const positionClasses = {
      'bottom-left': 'bottom-[280px] sm:bottom-64 left-8',
      'bottom-right': 'bottom-[280px] sm:bottom-64 right-8',
      'bottom-center': 'bottom-[280px] sm:bottom-64 left-1/2 -translate-x-1/2',
    }[position] || 'bottom-[280px] sm:bottom-64 left-8';
