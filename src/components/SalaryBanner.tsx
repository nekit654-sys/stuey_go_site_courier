...
const SalaryBanner = ({ onClose }: SalaryBannerProps) => {
  return (
    <div className="fixed top-0 md:bottom-1/2 md:top-auto md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 left-0 right-0 md:left-auto md:right-auto z-[60] bg-yellow-400 border-b md:border border-yellow-500 shadow-lg md:rounded-2xl md:max-w-4xl mx-auto">
