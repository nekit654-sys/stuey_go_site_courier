...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-12 px-4 md-elevation-8 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-gray-900/10 via-black/10 to-gray-900/10"></div>
