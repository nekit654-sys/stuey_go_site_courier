  ...
  const cards = [
    {
      ...
      subtext: stats.self_bonus_completed ? '✅ Самобонус получен' : `📦 Заказов: ${stats.self_orders_count || 0}/30`,
    ...
    },
    {
      icon: 'Gift',
      label: 'Самобонус',
      value: stats.self_bonus_completed ? '✅ Получен' : `${stats.self_orders_count || 0}/30`,
      subtext: stats.self_bonus_completed ? '3000₽ выполнено' : `Ещё ${Math.max(0, 30 - (stats.self_orders_count || 0))} заказов до 3000₽`,
