...
const Benefits = () => {
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Зарабатывайте до 10000₽ в день с Stuey.Go. Каждодневные выплаты на карту без задержек.",
    },
    {
      icon: "Activity",
    ...
    <section className="py-16 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-xl text-center mb-12 text-gray-600 max-w-2xl mx-auto">
          Присоединяйтесь к Stuey.Go — современной курьерской службе с высокими
          зарплатами и каждодневными выплатами!
        </p>
