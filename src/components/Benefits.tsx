  ...
  const benefits = [
    {
      ...
      title: "Гибкий график",
      description:
        "Работайте когда удобно. Совмещайте с учёбой или другой работой.",
    },
    {
      icon: "Wallet",
      title: "Стабильный заработок",
      description:
        "От 40 000₽ при 4-5 часах в день, до 180 000₽ при полной занятости (Москва, авто). Выплаты вт-чт, за сб-вс — в пн.",
    },
    {
      icon: "Zap",
      title: "Активный образ жизни",
      description:
        "Движение на свежем воздухе вместо офисного кресла.",
    },
    {
      icon: "Map",
      title: "Изучите город",
      description:
        "Откройте новые районы и места. Станьте экспертом своего города.",
    },
    {
      icon: "Rocket",
      title: "Простый старт",
      description:
        "Начните уже сегодня. Не нужен опыт или образование.",
    },
    {
      icon: "Users",
      title: "Новые знакомства",
      description:
        "Общайтесь с людьми и получайте благодарность за помощь.",
    },
  ];
