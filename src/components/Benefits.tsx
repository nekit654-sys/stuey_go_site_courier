  ...
  const benefits = [
    {
      ...
      title: "Гибкий график",
      description:
        "Работайте когда удобно вам — выбирайте смены сами и планируйте свой день. Совмещайте работу с учёбой, семьёй или другими делами без стресса.",
    },
    {
      icon: "Wallet",
      title: "Хороший заработок",
      description:
        "Зарабатывайте от 80 000 ₽ в месяц. Чем больше заказов выполняете, тем выше доход. Еженедельные выплаты и прозрачная система расчётов.",
    },
    {
      icon: "Zap",
      title: "Активный образ жизни",
      description:
        "Работа курьером — это постоянное движение на свежем воздухе. Поддерживайте форму, будьте в тонусе и забудьте про сидячий офис.",
    },
    {
      icon: "Map",
      title: "Знакомство с городом",
      description:
        "Изучите свой город как никогда раньше — новые районы, интересные места и скрытые локации. Станьте настоящим экспертом городской географии.",
    },
    {
      icon: "Rocket",
      title: "Простота старта",
      description:
        "Начните работать уже сегодня! Не нужно специальное образование или опыт. Просто пройдите регистрацию и выходите на первый заказ.",
    },
    {
      icon: "Users",
      title: "Общение с людьми",
      description:
        "Встречайте новых людей каждый день, помогайте клиентам и получайте благодарность. Работа курьера — это живое общение и позитивные эмоции.",
    },
  ];
